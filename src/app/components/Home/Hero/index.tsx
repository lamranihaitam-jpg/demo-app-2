        ...
        <div className='grid grid-cols-1 lg:grid-cols-12 lg:gap-1 gap-10 items-center'>
          <div className='col-span-6 flex flex-col gap-8'>
            <div className='flex gap-2 mx-auto lg:mx-0'>
              ...
              <p className='text-success text-sm font-semibold text-center lg:text-start tracking-widest uppercase'>
                Profitez de -30 % dès maintenant
              </p>
            </div>
            <h1 className='text-midnight_text lg:text-start text-center font-semibold leading-tight capitalize'>
              Formation de référence en sûreté & sécurité
            </h1>
            <p className='text-black/70 text-lg lg:text-start text-center max-w-xl'>
              Nous formons, partout en France, les professionnels de la sécurité dont les entreprises ont besoin
            </p>
            {/* recherche supprimée par demande utilisateur */}
          ...
          <div className='col-span-6 flex justify-center'>
            <Image
              ...
              width={1000}
              height={805}
              className='w-full h-[550px] object-cover rounded-lg  ml-56'
            />
          </div>
        </div>
      </div>
